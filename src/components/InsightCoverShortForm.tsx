...
const ACCENT = new THREE.Color("#E76A7A");
  ...
  return (
    <group ref={groupRef} position={position}>
      ...
      <lineSegments geometry={edgeGeo}>
        <lineBasicMaterial color="#E76A7A" transparent opacity={0.35} />
      </lineSegments>
      {/* Scrolling bars */}
      ...
      <mesh position={[0, 0, 0.02]}>
        ...
        <meshBasicMaterial color="#E76A7A" transparent opacity={0.4} />
      </mesh>
    </group>
  );
}
...
function Sparkles() {
  ...
  return (
    <points ref={ref}>
      ...
      <pointsMaterial color="#E76A7A" size={0.03} transparent opacity={0.6} sizeAttenuation />
    </points>
  );
}
