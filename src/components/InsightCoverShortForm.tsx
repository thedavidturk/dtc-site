...
const ACCENT = new THREE.Color("#8a0467");
  ...
  return (
    <group ref={groupRef} position={position}>
      ...
      <lineSegments geometry={edgeGeo}>
        <lineBasicMaterial color="#8a0467" transparent opacity={0.35} />
      </lineSegments>
      {/* Scrolling bars */}
      ...
      <mesh position={[0, 0, 0.02]}>
        ...
        <meshBasicMaterial color="#8a0467" transparent opacity={0.4} />
      </mesh>
    </group>
  );
}
...
function Sparkles() {
  ...
  return (
    <points ref={ref}>
      ...
      <pointsMaterial color="#8a0467" size={0.03} transparent opacity={0.6} sizeAttenuation />
    </points>
  );
}
