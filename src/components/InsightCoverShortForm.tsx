  ...
  return (
    <group ref={groupRef} position={position}>
      ...
      <lineSegments geometry={edgeGeo}>
        <lineBasicMaterial color="#fffdf9" transparent opacity={0.35} />
      </lineSegments>
      {/* Scrolling bars */}
      ...
      <mesh position={[0, 0, 0.02]}>
        ...
        <meshBasicMaterial color="#fffdf9" transparent opacity={0.4} />
      </mesh>
    </group>
  );
}
...
function Sparkles() {
  ...
  return (
    <points ref={ref}>
      ...
      <pointsMaterial color="#fffdf9" size={0.03} transparent opacity={0.6} sizeAttenuation />
    </points>
  );
}
