...
function AnimationMeasurementLines() {
  ...
  return (
    <>
      <Line points={verticalLine} color="#03624c" lineWidth={1} transparent opacity={0.4} />
      <Line points={vertTickTop} color="#03624c" lineWidth={1} transparent opacity={0.4} />
      <Line points={vertTickBottom} color="#03624c" lineWidth={1} transparent opacity={0.4} />
      <Line points={horizontalLine} color="#03624c" lineWidth={1} transparent opacity={0.4} />
      <Line points={horizTickLeft} color="#03624c" lineWidth={1} transparent opacity={0.4} />
      <Line points={horizTickRight} color="#03624c" lineWidth={1} transparent opacity={0.4} />
    </>
  );
}
