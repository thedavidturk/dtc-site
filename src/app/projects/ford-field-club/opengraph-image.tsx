...
export const alt = "MIAMI DOLPHINS - Ford Field Club at Hard Rock Stadium";
...
export default async function OgImage() {
  const poster = await loadDataUri("ford-field-club.jpg");
    ...
    (
      ...
      >
        ...
        >
          ...
          >
            Ford Field Club at Hard Rock Stadium
          </div>
        </div>
      </div>
    ),
