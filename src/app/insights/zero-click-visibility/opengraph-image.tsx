...
export const alt = "Zero-Click Is Here: Getting Found When Nobody Visits Your Site";
export const size = { width: 1200, height: 630 };
export const contentType = "image/png";

const POSTER = "pamm.jpg";
const CATEGORY = "AI + DISCOVERY";
const TITLE = "Zero-Click Is Here: Getting Found When Nobody Visits Your Site";
