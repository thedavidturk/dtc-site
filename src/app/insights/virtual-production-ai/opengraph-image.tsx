...
export const alt = "Virtual Production Without the Volume";
export const size = { width: 1200, height: 630 };
export const contentType = "image/png";

const POSTER = "ford-field-club.jpg";
const CATEGORY = "VIRTUAL PRODUCTION";
const TITLE = "Virtual Production Without the Volume";
