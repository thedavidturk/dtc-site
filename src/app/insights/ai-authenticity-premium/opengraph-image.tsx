...
export const alt = "The Authenticity Premium: Winning Trust in the Age of Fake AI";
export const size = { width: 1200, height: 630 };
export const contentType = "image/png";

const POSTER = "faena.jpg";
const CATEGORY = "BRAND + TRUST";
const TITLE = "The Authenticity Premium: Winning Trust in the Age of Fake AI";
