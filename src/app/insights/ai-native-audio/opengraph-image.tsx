...
export const alt = "Native Audio: The Year AI Learned to Score Its Own Footage";
export const size = { width: 1200, height: 630 };
export const contentType = "image/png";

const POSTER = "unplugged.jpg";
const CATEGORY = "AI + PRODUCTION";
const TITLE = "Native Audio: The Year AI Learned to Score Its Own Footage";
