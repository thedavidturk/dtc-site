...
const moreArticles = [
  ...
  },
  {
    ...
    gradient: "from-pink-500/30 via-rose-900/50 to-sand",
  },
];
  ...
  return (
    <article className="bg-sand min-h-screen">
      ...
      <section className="relative min-h-[60vh] md:min-h-[70vh] flex items-end overflow-hidden">
        ...
        <div className="absolute top-1/4 right-[20%] w-36 h-36 border border-ink/[0.06] rounded-full animate-pulse" />
        <div className="absolute top-2/5 left-1/4 w-16 h-16 border border-ink/10 rounded-lg rotate-45" />
