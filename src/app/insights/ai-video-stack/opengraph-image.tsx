...
export const alt = "After Sora: The Best Brand Video Now Comes From a Stack";
export const size = { width: 1200, height: 630 };
export const contentType = "image/png";

const POSTER = "new-era-cosmic.jpg";
const CATEGORY = "AI + VIDEO";
const TITLE = "After Sora: The Best Brand Video Now Comes From a Stack";
