...
const moreArticles = [
  {
    ...
    gradient: "from-regatta/30 via-amber-900/40 to-sand",
  },
  {
  ...
  return (
    <article className="bg-sand min-h-screen">
      ...
      <section className="relative min-h-[60vh] md:min-h-[70vh] flex items-end overflow-hidden">
        ...
        <div className="absolute top-1/4 left-[18%] w-28 h-28 border border-ink/[0.06] rounded-full animate-pulse" />
        <div className="absolute top-1/3 right-[15%] w-20 h-20 border border-ink/10 rounded-xl rotate-12" />
